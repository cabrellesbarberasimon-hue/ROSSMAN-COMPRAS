...
La app queda en la dirección principal del proyecto. En Vercel los datos se guardan en el navegador de cada usuario (`localStorage`); para compartirlos entre el equipo usa *Exportar / Importar Excel*.
